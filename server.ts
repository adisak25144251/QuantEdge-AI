...
app.use((_req, res, next) => {
    ...
    res.setHeader("Content-Security-Policy", [
        ...
        `connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://*.firebaseapp.com https://query1.finance.yahoo.com https://query2.finance.yahoo.com https://api.binance.com https://data-api.binance.vision https://api1.binance.com https://api2.binance.com https://api3.binance.com https://api.binance.me https://api.binance.info https://s.tradingview.com https://s3.tradingview.com https://www.tradingview.com https://*.tradingview.com https://www.tradingview-widget.com https://*.tradingview-widget.com wss://*.firebaseio.com wss://stream.binance.com:9443 wss://*.binance.com wss://*.tradingview.com${isProd ? "" : " ws: wss:"}`,
