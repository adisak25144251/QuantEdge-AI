...
test('professional evidence passes only complete OOS walk-forward forward and slippage evidence', () => {
  const report = evaluateProfessionalEvidence({
    ...
    walkForward: { status: 'PASS', windows: 4, windowResults: [], positiveWindowRate: 75, minWindowExpectancyR: 0.05, averageWindowExpectancyR: 0.2, maxWindowDrawdownPercent: 14, issues: [] },
